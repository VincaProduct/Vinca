  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-6 sm:px-8 py-8 sm:py-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-start mb-12">
        {/* Left: Pricing Summary & CTA */}
        <div className="space-y-6 md:pr-8">
          <div className="text-2xl sm:text-3xl font-bold text-emerald-900 mb-2">Membership fees & inclusions</div>
          <div className="flex items-end gap-3 mb-4">
            <span className="text-4xl sm:text-5xl font-bold text-emerald-700">₹2500</span>
            <span className="text-lg sm:text-xl font-medium text-emerald-700">/ year</span>
          </div>
          <button className="w-full md:w-auto px-8 py-3 rounded-xl bg-emerald-600 text-white font-semibold text-lg sm:text-xl hover:bg-emerald-700 transition shadow-lg hover:shadow-xl"
            onClick={() => window.location.href = '/dashboard/buy-membership'}>
            Join Membership
          </button>
        </div>

        {/* Right: Feature Inclusions List */}
        <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 md:p-8">
          ...
          <ul className="space-y-3">
            ...
            <li className="flex items-start gap-3 text-base text-slate-800">
              <Rocket className="h-5 w-5 text-emerald-500 shrink-0 mt-0.5" />
              <span>Sprints for consistent, focused progress</span>
            </li>
            <li className="flex items-start gap-3 text-base text-slate-800">
              <Footprints className="h-5 w-5 text-emerald-500 shrink-0 mt-0.5" />
      ...
      {/* FOOTER NOTE */}
      <div className="text-[10px] sm:text-xs text-slate-500 mt-10 text-center">
