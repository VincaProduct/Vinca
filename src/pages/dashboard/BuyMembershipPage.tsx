    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 animate-fadeIn" onClick={onClose}>
      <div className="bg-card rounded-3xl shadow-2xl p-8 max-w-sm w-full text-center" onClick={e => e.stopPropagation()}>
        ...
        <div className="flex flex-col gap-3">
          <Button className="w-full bg-emerald-600 text-white font-semibold py-3 rounded-xl hover:bg-emerald-700 transition" onClick={() => window.location.href = '/auth'}>
            Continue to Sign In
          </Button>
...
export default function DashboardBuyMembershipPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Full-width container with proper dashboard spacing */}
      <div className="w-full px-6 sm:px-8 lg:px-12 py-10">
        <div className="w-full max-w-7xl mx-auto space-y-10">
          
          {/* 1️⃣ About Subscription - Full Width Card */}
          <Card className="w-full p-8 border border-border bg-card shadow-sm">
          ...
          {/* 2️⃣ Step Progress Indicator - Full Width with centered content */}
          ...
          {/* 3️⃣ Dynamic Step Content - Full Width */}
