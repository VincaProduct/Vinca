...
import Vincavector from "./pages/dashboard/Vincavector";
...
// import InsurancePage from "./pages/dashboard/InsurancePage"; // COMMENTED OUT - Removed module
        ...
        <ReferralProvider>
          ...
          <Routes>
            ...
            >
              ...
              <Route path="anchor" element={<Vincavector />} />
              {/* COMMENTED OUT - Removed modules */}
              ...
              {/* <Route path="insurance" element={<InsurancePage />} /> */} {/* COMMENTED OUT - Removed module */}
